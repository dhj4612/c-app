...
export default forwardRef((props, ref) => {
  ...
  const [formState, setFormState] = useState({
    currentAddress2: userState.evaluateFormData.currentAddress2, // 紧急联系人详细地址
    workCondition: userState.evaluateFormData.workCondition, // 工作状态
    studentPurposeString: userState.evaluateFormData.studentPurposeString, // 学习意向
  });
